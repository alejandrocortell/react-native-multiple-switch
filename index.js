...
var MultipleSwitch = function (props) {
    ...
    // GUI //
    /////////
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, __assign({ style: getContainerStyle(), onLayout: function (event) {
            setContainerWidth(event.nativeEvent.layout.width);
            containerWidthRef.current = event.nativeEvent.layout.width;
        } }, { children: [(0, jsx_runtime_1.jsx)(react_native_1.Animated.View, { style: [getSliderStyle()] }), props.items.map(function (item, index) {
                return ((0, jsx_runtime_1.jsx)(react_native_1.TouchableOpacity, __assign({ activeOpacity: 0.7, style: [
                        style_1["default"].item,
                        {
                            width: "".concat(100 / props.items.length, "%")
                        }
                    ], onPress: function () { return runAnimation(item, index); }, disabled: props.disabled }, { children: (0, jsx_runtime_1.jsx)(react_native_1.Text, __assign({ style: getTextStyle((props.value === item.uniqueId)), numberOfLines: 1 }, { children: item.displayName })) }), index));
            })] })));
};
